 ...
 * Created by tao.
 * <p>
 * Created Time : 2017/1/4 11:38.
 * <p>
 * Description : File in  myview, Project in MyDemo.
 * <p>
 * Content:这是一个自定义的EditText,可以一键清空输入内容
 */
...
public class ClearEditText extends EditText implements View.OnTouchListener, View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (_right == null) {
            ...
            _right = getResources().getDrawable(R.mipmap.error_72px);
